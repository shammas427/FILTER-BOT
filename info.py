...
API_ID = int(environ.get('API_ID', '39731630'))
API_HASH = environ.get('API_HASH', '6f455cf36befdefbb9d58f9890bc20b4')
BOT_TOKEN = environ.get('BOT_TOKEN', "8778423258:AAGqLHXAUKwrTF-OrTN3eRxhzaTcvNarDwM")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8659689209').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003936650258'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003996121096').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003721626779') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-5046783562')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003926489822').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Asbro:<SHAMMASCP>@cluster0.axvc77w.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/PremiumChats235')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+MuE0fTZBnmAzYmJl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+9UMFsCoiOyIyYmFl') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/asbro02')
